<?php
    function prikaz($start)
    {
        ...
        while ($r = mysqli_fetch_assoc($query_run)){
            echo "<tr>";
            echo "<td>".$r['fname']."</td>"."<td>".$r['lname']."</td>"."<td>".$r['subject_name']."</td>"."<td>".$r['grades_br']."</td>"."<td>".$r['class_name']."</td>"."<td class='edit'>"; ?><a id="edit" href="editt.php?student_id=<?php echo $r['student_id'];?>">Grade</a> <?php echo"</td>";
            echo "</tr>";
        }
    }
