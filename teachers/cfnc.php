<?php
    function prikaz($start)
    {
        ...
        $query = "SELECT student.student_id, student.fname, student.lname, subject.subject_name, grades.grades_br, class.class_name FROM student, class, subject, grades, teacher WHERE student.subject_id = subject.subject_id AND student.grades_id = grades.grades_id AND student.teacher_id = teacher.teacher_id AND student.class_id = class.class_id AND class.class_name = '1st' AND teacher.tfname = '".$_SESSION ['tfname']."' LIMIT $start, $pps";
        ...
        while ($r = mysqli_fetch_assoc($query_run)){
            echo "<tr>";
            echo "<td>".$r['fname']."</td>"."<td>".$r['lname']."</td>"."<td>".$r['subject_name']."</td>"."<td>".$r['grades_br']."</td>"."</td>"."<td>".$r['class_name']."</td>"."<td class='edit'>"; ?><a id="edit" href="editt.php?student_id=<?php echo $r['student_id'];?>">Grade</a> <?php echo"</td>"; 
            echo "</tr>";
        }
    }
